        ...
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500 mt-1">
                  Prints at the bottom of the invoice receipt: <span className="font-semibold text-slate-700">"This invoice was generated by {createdBy || currentUser.name}"</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-5 sm:p-6 border border-slate-200 shadow-sm space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              ...
              <button
                type="button"
                onClick={() => setSelectedCustomerId(selectedCustomerId === 'new' ? (customers[0]?.id || 'new') : 'new')}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Plot 14, Block C, Banani, Dhaka"
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-300 rounded-xl text-sm font-medium text-slate-800 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0F3B2C] transition-all"
                />
              </div>
            </div>
